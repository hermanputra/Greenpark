        ...
        <div class="portfolio portfolio-page container">
            <div class="row">
                <div class="portfolio-navigator span12">
                    <h4 class="filter-portfolio">
                        ...
                        <a class="web-design" id="" href="#">Indoor</a> /
                        <a class="logo-design" id="" href="#">Outdoor</a> 
            ...
            <div class="row">
                <ul class="portfolio-img">
                    <li data-id="p-1" data-type="logo-design" class="span3">
                        <div class="work">
                    ...
                    <li data-id="p-2" data-type="logo-design" class="span3">
                        <div class="work">
                            <a href="assets/img/facilities/work2.jpg" rel="prettyPhoto">
                                <img src="assets/img/facilities/work2.jpg" alt="">
                            </a>
                            <h4>Terrace</h4>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor.</p>
                        </div>
                    </li>
                    <li data-id="p-3" data-type="web-design" class="span3">
                        <div class="work">
                            <a href="assets/img/facilities/work3.jpg" rel="prettyPhoto">
                                <img src="assets/img/facilities/work3.jpg" alt="">
                            </a>
                            <h4>Pantry</h4>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor.</p>
                        </div>
                    </li>
                    <li data-id="p-4" data-type="logo-design" class="span3">
                        <div class="work">
                    ...
                    <li data-id="p-5" data-type="web-design" class="span3">
                        <div class="work">
                    ...
                    <li data-id="p-6" data-type="web-design" class="span3">
                        <div class="work">
                    ...
                    <li data-id="p-8" data-type="web-design" class="span3">
                        <div class="work">
                    ...
                    <li data-id="p-10" data-type="web-design" class="span3">
                        <div class="work">
